...
struct ARViewContainer:UIViewRepresentable{
    ...
    private func place(_ modelEntity: ModelEntity, in arView: ARView) {
        ...
        //1. Clone modelEntity. This creates an identical copy of modelEntity and references the same model. This also allows us to have multiple models of the same assets in our scene.
